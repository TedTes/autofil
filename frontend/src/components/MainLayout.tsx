...
//       label: 'Documents',
//       icon: FolderTree,
//       onClick: () => navigateTo('files', undefined, ['Home', 'Documents']),
//     },
//     {
//       id: 'folders',
//       label: 'Folders',
//       icon: FolderPlus,
//       onClick: () => navigateTo('folders', undefined, ['Home', 'Folders']),
//     },
//     {
//       id: 'history',
//       label: 'History',
...
//         {/* Header ... keep your current header */}
...
//               <FileDetailView data={currentView.data} currentFolder={currentFolder} />
//             )}

//             {currentView.type === 'folders' && (
//               <FolderView
//                 folders={folders}
//                 onSelectFolder={(folder) => {
//                   setCurrentFolder(folder)
//                   navigateTo('files', undefined, ['Home', 'Documents', folder.name])
//                 }}
